        ...
        if (!"".equals(txtCodigo.getText()) && !"".equals(txtCantidad.getText()) && CalendarElaboracion.getDate() !=null && CalendarCaducidad.getDate() !=null){
            ...
            if (validadLote()){
                ...
                try(Connection conn = dataSource.getConnection()){
                        ...
                        Query = "UPDATE `articulo` SET `Existencia` = ( SELECT IFNULL(SUM(Cantidad),0) AS Total FROM articulo_lote WHERE Activo = 1 AND IDArticulo = '" + IDArticulo + "' ) WHERE `ID` = '" + IDArticulo + "'";
                        stmt.executeUpdate(Query);
